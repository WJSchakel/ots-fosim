...
public class ParameterDefinitions
{
    ...
    public static List<ParameterGroup> getParameterGroups()
    {
        ...
        group.addParameter(new Parameter("b", it("b"), sc("m/s^2")).setMin("b0").setMax("bCrit").setDefault(2.09, 2.09)
                .setDescriptionNl("Maximale gewenste deceleratie.").setDescriptionEn("Maximum desired deceleration."));
        group.addParameter(new Parameter("bCrit", it("b_crit"), sc("m/s^2")).setMin("b").setMax(8.0).setDefault(3.5, 3.5)
                .setDescriptionNl("Kritieke deceleratie, bv. bij verkeerslichten.")
        ...
        group.addParameter(new Parameter("dSync", it("d_sync"), "-").setMin("dFree").setMax("dCoop").setDefault(0.577, 0.577)
                .setDescriptionNl("Drempelwaarde rijstrookwisselwens synchroniseren snelheid.")
        ...
        group.addParameter(new Parameter("x0", it("x_0"), "m").setMin(100.0).setMax(1000.0).setDefault(295.0, 295.0)
                .setDescriptionNl("Anticipatie afstand rijstrookwisselen per strook.")
                .setDescriptionEn("Lane change anticipation distance per lane change."));
        group.addParameter(new Parameter("t0", it("t_0"), "s").setMin(10.0).setMax(120.0).setDefault(43.0, 43.0)
                .setDescriptionNl("Anticipatie tijd rijstrookwisselen per strook.")
                .setDescriptionEn("Lane change anticipation time per lane change."));
        group.addParameter(new Parameter("vGain", it("v_gain"), "km/h").setMin(1.0).setMax(130.0).setDefault(69.6, 69.6)
                .setDescriptionNl("Snelheidswinst voor maximaal gewenste rijstrookwisseling.")
                .setDescriptionEn("Speed gain for maximally desired lane change."));
        group.addParameter(new Parameter("vCong", it("v_cong"), "km/h").setMin(1.0).setMax(130.0).setDefault(60.0, 60.0)
                .setDescriptionNl("File drempelsnelheid.").setDescriptionEn("Threshold speed for congestion."));
        group.addParameter(new Parameter("LCdur", it("LC_dur"), "s").setMin(1.0).setMax(5.0).setDefault(3.0, 3.0)
                .setDescriptionNl("Duur van een strookwisseling.").setDescriptionEn("Duration of a lane change."));
        list.add(group);
        ...
        group.addParameter(new Parameter("TSmax", it("TS_max"), "-").setMin("TScrit").setMax(3.0).setDefault(2.0, 2.0)
                .setDescriptionNl("Maximale taak saturatie <i>TS</i>.").setDescriptionEn("Maximum task saturation <i>TS</i>."));
        group.addParameter(new Parameter("SAmin", it("SA_min"), "-").setMin(0).setMax("SAmax").setDefault(0.5, 0.5)
                .setDescriptionNl("Minimale situationele aandacht <i>SA</i>.")
        ...
        group.addParameter(new Parameter("SAmax", it("SA_max"), "-").setMin("SAmin").setMax(1.0).setDefault(1.0, 1.0)
                .setDescriptionNl("Maximale situationele aandacht <i>SA</i>.")
        ...
        group.addParameter(new Parameter("Trmax", it("T_r,max"), "s").setMin(0.0).setMax(3.0).setDefault(2.0, 2.0)
                .setDescriptionNl("Maximale reactietijd <i>T<sub>r</sub></i>.")
