...
/**
 * Time-to-collision for trajectories. Slightly different implementation from OTS due to
 * https://github.com/averbraeck/opentrafficsim/issues/262.
 * <p>
        ...
        try
        {
            ...
            while (set.size() == 1)
            {
                ...
                else
                {
                    ...
                    // Due to https://github.com/averbraeck/opentrafficsim/issues/262
                    Length ownPos = ref.position().plus(gtuObj.getFront().dx());
